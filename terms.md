# Terms of Use — The Mechanic

**Last updated:** 16 September 2026  
**App:** The Mechanic.  
**Owner:** Ivan Rodriguez.

These terms are short on purpose. By using the app, you agree to them.
...
Do not pretend to be Bethesda or the owner. Do not use the app if you are under 13.

## 5. Content and IP

Fan use of ESO names in fight notes does not make this an official product.

## 6. No warranty

The app is provided **as is**. Guides can be incomplete or out of date.
...
If these terms change in a material way, we will bump the date here. Continued use after that date is acceptance. The in-app copy is the same document.

## 9. Contact

**Ivan Rodriguez**, owner. Settings → About, or https://github.com/ivan-j-rodriguez/the-mechanic-demo/issues.
